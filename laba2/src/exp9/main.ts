...
function sortAndDisplay() {
    ...
    const resultElement = document.getElementById('sortedResult') as HTMLParagraphElement;
    const errorElement = document.getElementById('errorOutput') as HTMLParagraphElement;
